...
def main():
    ...
    st.write("This application uses L1 and L2 Regularization Linear Regression to predict sleep disorders based on health and lifestyle data.")
    ...
    # Train model
    model = L1LinearRegression(learning_rate=learning_rate, 
    ...
    ax.set_title('Feature Importance (L1 Regularization)')
    st.pyplot(fig)
